...
def main(csv_file: str, csv_extension: str, output_qmd: str, output_yml: str) -> None:
    try:
        ...
        # Serialisiere die Expert Base als JSON für die Begutachtung.
        expert_base.serialize_expert_base("Expert-Base-Builder/backup.json")
...
if __name__ == "__main__":
    ...
    main(
        ...
        csv_extension="config/property_extension.csv",
